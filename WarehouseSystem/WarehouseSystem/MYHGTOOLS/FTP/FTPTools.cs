...
namespace MYHGTOOLS.FTP
{
    public class FTPTools
    {
        ...
        public FTPTools(string host, string userId, string password)
        ...
        public FTPTools(string host, string userId, string password, int port, IWebProxy proxy, bool enableSsl, bool useBinary, bool usePassive)
        {
            this.userId = userId;
