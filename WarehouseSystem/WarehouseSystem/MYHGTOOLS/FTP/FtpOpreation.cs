...
namespace MYHGTOOLS.FTP
{
    ...
    public class FTPClient
    {
        ...
        public void Get(string strFileNameMask, string strFolder)
        {
            ...
            foreach (string strFile in strFiles)
            {
                if (!strFile.Equals(""))//一般来说strFiles的最后一个元素可能是空字符串  
                {
                    ...
                    FTPTools ftToo = new FTPTools(RemoteHost, RemoteUser, RemotePass);
                    ftToo.Download(strFile.Replace("\r",""), strFolder + "\\strFile");
                }
            }
        }
        /// <summary>  
        ...
        {
            strRemoteFileName = strRemoteFileName.Replace("\r", "");
            strLocalFileName = strLocalFileName.Replace("\r", "");
            if (!bConnected)
            {
                Connect();
            }
            ...
            FileStream output = new
             FileStream(strFolder + "\\" + strLocalFileName, FileMode.OpenOrCreate);
            Socket socketData = CreateDataSocket();
        ...
        public string Get(string strRemoteFileName)
        {
            return string.Empty;
        }
        /// <summary>  
