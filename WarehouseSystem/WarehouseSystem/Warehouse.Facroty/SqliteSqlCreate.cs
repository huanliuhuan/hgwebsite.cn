...
{
    public class SqliteSqlCreate<T>
    {
        ...
        public static string Select(T Model)
        {
            ...
            string result = String.Format(SqliteSql.SqlSelect, CreateFields(Model), Model.GetType().Name, Where);
            return result;
        }
        ...
        public static string SelectByPage(T Model, string SortField, string Sort)
        {
            ...
            int PageSzie = 0; //页面大小
            StringBuilder Where = CreateWhere(Model, ref PageIndex, ref PageSzie);
            return String.Format(SqliteSql.PageSel, CreateFields(Model).ToString(), SortField, Sort, Model.GetType().Name, Where, ((PageIndex - 1) * PageSzie).ToString(), PageSzie.ToString());
        }
        /// <summary>
        /// 总页数
        /// </summary>
        ...
        public static string SelectByPage(T Model)
        {
            ...
            int PageSzie = 0; //页面大小
            StringBuilder Where = CreateWhere(Model, ref PageIndex, ref PageSzie);
            return String.Format(SqliteSql.RecordCount, Model.GetType().Name, Where);
        }
        ...
        public static string SelectByGPage(T Model, string GroupField, string SortField, string Sort)
        {
            ...
            return String.Format(SqliteSql.GroupSelect, GroupField, Model.GetType().Name, SortField, SortField, Sort, ((PageIndex - 1) * PageSzie).ToString(), PageSzie.ToString());
        }
        ...
        {
            return String.Format(SqliteSql.tempSelect, String.Format(SqliteSql.SqlSelect, GroupField, Model.GetType().Name, " GROUP BY  " + GroupField + ""));
        }
        ...
        /// idname
        /// </summary>
        private static string idname = string.Empty;
        ...
        public static List<StringBuilder> ValueFieldsAndParam(T Model)
        {
            ...
            foreach (PropertyInfo Info in _Type.GetProperties())
            {
                if (index == 0) idname = Info.Name; index++;//索引加1；
                object obj = Info.GetValue(Model, null);//获取值
                if (obj == null) continue;
        ...
        public static string Insert(T Model)
        {
            ...
            return String.Format(SqliteSql.SqliteInsert, Model.GetType().Name, lsb[0].ToString(), lsb[1].ToString(), idname);
        }
        ...
        /// <param name="Model"></param>
        /// <returns></returns>
        public static string InsertSync(T Model)
        {
            List<StringBuilder> lsb = ValueFieldsAndParam(Model);
            return String.Format(SqliteSql.SqlInsert, Model.GetType().Name, lsb[0].ToString(), lsb[1].ToString(), idname);
        }
        ...
        {
            return String.Format(SqliteSql.SqlUpdate, Model.GetType().Name, UpDateSql(Model), Where);
        }
        ...
        {
            return String.Format(SqliteSql.SqlDelete, Model.GetType().Name, Where);
        }
